    ...
    <div v-if="!guodu">
      ...
      <section class="msg-scoll-hidden">
        <section class="msg-star-wrap">
          <h3>演职人员</h3>
          <div class="msg-scoll">
            <div class="msg-star" v-for="item in movieMsg.directors" @click="starMsg(item.id)">
              <div>
            ...
            <div v-for="item in movieMsg.casts" @click="starMsg(item.id)">
              <div>
                <img :src="item.avatars.small" :alt="item.alt">
              </div>
              <div class="msg-star-name">
...
//        console.log(this.$route.params.id)
        const id = '/api/movie/subject/' + this.$route.params.id + '?apikey=0b2bdeda43b5688921839c8ecb20399b'
        this.$http.get(id).then(function (res) {
          _this.guodu = false
