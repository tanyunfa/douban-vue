  ...
  <div class="come-soon">
    ...
    <div v-if='!guodu' class="co-theaters-area">
      <div class="co-movies-wrap">
        <div class="co-movies-show" v-for="(item, index) in coming_soon_data_body_subjects"
    ...
    mounted: function () {
      ...
      this.$http.get('/api/movie/coming_soon')
        .then(function (response) {
          _this.guodu = false
          _this.coming_soon_data = response
          _this.coming_soon_data_body = response.data
          _this.coming_soon_data_body_subjects = response.data.subjects
        })
