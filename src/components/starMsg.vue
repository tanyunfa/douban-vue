  ...
  <div>
    ...
    <div v-if="!guodu">
      ...
      <section class="star-movie-wrap">
        ...
        <div class="star-movie" v-for="item in starMsg.works" @click="moviesMsg(item.subject.id)">
          <div>
...
<script>
  ...
  export default {
    ...
    mounted: function () {
      const _this = this
      this.$http.get('api/movie/celebrity/' + this.$route.params.id).then(function (res) {
        _this.guodu = false
        _this.starMsg = res.data
