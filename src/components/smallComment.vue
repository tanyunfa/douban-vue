<template>
  <div>
    ...
    <div v-if="!guodu">
      ...
      <section class="all-smallCom" v-for="item in commentsMsg.comments">
        <div class="smallCom">
...
<script>
  ...
  export default {
    ...
    mounted: function () {
      const _this = this
      this.$http.get('/api/movie/subject/' + this.$route.params.id + '/comments?apikey=0b2bdeda43b5688921839c8ecb20399b').then(function (res) {
        _this.guodu = false
